...
// Preparer for Brew Package
//
// Brew Package manages system packages with `brew`. It assumes that
...
func (p *Preparer) Prepare(ctx context.Context, render resource.Renderer) (resource.Task, error) {
	...
	return &pkg.Package{
		Name:  p.Name,
		State: p.State,
		PkgManager{Sys: pkg.ExecCaller{}},
	}, nil
}

func init() {
	registry.Register("package.brew", (*Preparer)(nil), (*pkg.Package)(nil))
}
